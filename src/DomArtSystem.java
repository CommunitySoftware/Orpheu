...
public class DomArtSystem extends JFrame 
{
	...
	public static void main(String[] args) 
	{
		EventQueue.invokeLater(new Runnable() 
		{
			public void run() 
			{
				try 
				{
					DomArtSystem frame = new DomArtSystem();
	...
	// Início do construtor DomArtSystem
	public DomArtSystem() 
	{
		setResizable(false);
		...
		// Criação do Frame 
		setTitle("Orpheu");
		setIconImage(Toolkit.getDefaultToolkit().getImage(DomArtSystem.class.getResource("/img/DomArt.jpg")));
		...
		ImageIcon imagem = new ImageIcon(DomArtSystem.class.getResource("/img/fundo.jpg"));
		...
		desktopPane.setBounds(40, 39, 258, 233);
		contentPane.add(desktopPane);
		
		JLabel lblVcxvcxvxcvxcv = new JLabel("vcxvcxvxcvxcv");
		lblVcxvcxvxcvxcv.setBounds(85, 138, 46, 14);
		desktopPane.add(lblVcxvcxvxcvxcv);
		
	}// Fim do Construtor DomArtSystem
}// Fim da classe DomArtSystem
